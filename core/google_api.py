...
def save_media_file(media_data: bytes, chat_id: str, file_id: str, mime_type: str, base_url: str, media_dir: str) -> str:
    """保存媒体文件（图片/视频）到持久化存储,返回完整的公开URL"""
    ext_map = {
        "image/png": ".png", "image/jpeg": ".jpg", "image/gif": ".gif", "image/webp": ".webp",
        "video/mp4": ".mp4", "video/webm": ".webm", "video/quicktime": ".mov"
    }
    ext = ext_map.get(mime_type, ".png" if mime_type.startswith("image") else ".mp4")
...
# 保持向后兼容
save_image_to_hf = save_media_file
