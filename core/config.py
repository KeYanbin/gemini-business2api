...
class BasicConfig(BaseModel):
    ...
    # 邮件提供商配置
    mail_provider: str = Field(default="chatgpt", description="邮件提供商：duckmail 或 chatgpt")
    # DuckMail 配置
    ...
    chatgpt_mail_api_key: str = Field(default="gpt-test", description="ChatGPT Mail API key")
    # 浏览器配置
...
class ConfigManager:
    ...
    def load(self):
        ...
        chatgpt_mail_api_key_raw = basic_data.get("chatgpt_mail_api_key", "gpt-test")

        basic_config = BasicConfig(
            api_key=basic_data.get("api_key") or "",
            base_url=basic_data.get("base_url") or "",
            proxy=basic_data.get("proxy") or "",
            mail_provider=basic_data.get("mail_provider") or "chatgpt",
            ...
            chatgpt_mail_api_key=str(chatgpt_mail_api_key_raw or "gpt-test").strip(),
